    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow('global.age'.tr(), widget.age),
          _buildInfoRow('global.dateofbirth'.tr(), widget.dateOfBirth),
          _buildInfoRow('global.level'.tr(), widget.level),
          _buildInfoRow('global.gender'.tr(), widget.gender),
        ],
      ),
    );
  }
