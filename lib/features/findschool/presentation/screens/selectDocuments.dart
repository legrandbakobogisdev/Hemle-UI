...
class _SelectdocumentsState extends State<Selectdocuments> {
  ...
  final List<Document> documents = [
    ...
    Document(
      id: '4',
      title: 'selectdocuments.recentreportcard.title'.tr(),
      description: 'selectdocuments.recentreportcard.desc'.tr(),
    ),
  ];
  ...
  Widget _footer() {
    return CustomFooter(
      onPressed: () {
        Navigator.push(
          context,
          CupertinoPageRoute(builder: (context) => ChildprofileScreen()),
        );
      },
