    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          // Full Name Section
          _buildSectionTitle('global.fullname'.tr()),
          ...
          _buildSectionTitle('global.level'.tr()),
          const SizedBox(height: 12),
          _buildLevelSection(),
        ],
      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CustomText(
                      label: _calculatedAge ?? 'global.age'.tr(),
                      fontSize: 14,
    ...
    return Column(
      ...
      children: [
        ...
        MyPopupMenuButton(
          ...
          label: _selectedLevel ?? 'global.level'.tr(),
        ...
        Column(
          ...
          children: [
            ...
            MyPopupMenuButton(
              ...
              color: const Color(0xFFF7F8FA),
              bordercolor: Color(0xFFE1E4E8),
              label: _selectedGender ?? 'global.gender'.tr(),
              onSelect: (value) {
                setState(() {
