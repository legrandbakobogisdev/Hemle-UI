...
class _ApplicationstatusScreenState extends State<ApplicationstatusScreen> {
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              _buildInfoRow('applicationstatus.submittedon', '09/03/2025'),
            ],
          ),
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow('global.dateofbirth', '10/01/2018'),
          _buildInfoRow('global.level', 'Grade 2'),
          _buildInfoRow('global.gender', 'Male'),
        ],
      ),
    );
  }
  ...
  Widget _footer() {
    return Container(
      ...
      child: CustomButton(
        onPressed: () {
          Navigator.pushReplacement(context, CupertinoPageRoute(builder: (context) => Layoutsupport(),));
        },
        isDisabled: false,
        fullWidth: true,
        label: 'globaal.backtohome'.tr(),
      ),
    );
  }
}
