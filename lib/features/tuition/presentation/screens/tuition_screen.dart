                ...
                if (_hasActiveFilters) ...[
                  ...
                  SizedBox(
                    ...
                    child: TextButton(
                      ...
                      child: CustomText(
                        label: 'tuition.clear_filters'.tr(),
                        color: AppColors.primary,
                        fontWeight: FontWeight.w500,
                      ),
                    ),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          CustomText(
            label: 'tuition.no_transactions'.tr(),
            fontSize: 16,
            color: AppColors.textSecondary,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isSelected ? AppColors.primary : const Color(0xFFE1E4E8),
                width: 2,
              ),
  ...
  Widget _payment() {
    return Padding(
      ...
      child: Column(
        ...
        spacing: 10,
        children: [
          ..._payments.map((payment) => _paymentCard(payment)),
        ],
      ),
    );
  }
            ...
            Row(
              ...
              children: [
                Expanded(child: CustomButton(label: 'global.paynow'.tr(), onPressed: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => MethodpaymentScreen()));
                })),
