...
class _DetailstransportsState extends State<Detailstransports> {
  ...
  Widget _header() {
    return CustomHeader(
      title: 'detailstransport.title'.tr(),
      desc: 'detailstransport.desc'.tr(),
    );
  }
      ...
      children: [
        ...
        CustomFooter(
          onPressed: () {
            Navigator.push(
              context,
              CupertinoPageRoute(builder: (context) => TrackingScreen()),
            );
          },
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? const Color(0xFF0065FF) : Colors.white,
                  width: 2,
                ),
                color: isSelected ? const Color(0xFF0065FF) : Color(0xFFDEEBFF),
              ),
              child: isSelected
