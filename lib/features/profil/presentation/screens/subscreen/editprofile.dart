...
class _EditprofileState extends State<Editprofile> {
      ...
      child: ListView(
        ...
        children: [
          Column(
            spacing: 10,
            children: [
              Customformsection(title: 'global.fullname'.tr(), isRequired: true, input: CustomTextField(controller: _fullname, type: TextFieldType.fullName)),
              
              Customformsection(title: 'global.phonenumber'.tr(), isRequired: true, input: PhoneField(onCountryChanged: _onCountryChanged, phoneController: phoneController, validator: _validatePhoneNumber,)),
              
              Customformsection(title: 'global.email'.tr(), isRequired: false, input: CustomTextField(controller: _email, type: TextFieldType.email)),
            ],
          ),
          ...
          Column(
            ...
            spacing: 8,
            children: [
              CustomText(label: 'global.children'.tr(), fontWeight: FontWeight.w600, fontSize: 15,),
      
              Column(
                children: childrens.map((child) => Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      CustomText(label: child['name']!, fontWeight: FontWeight.w500),
  ...
  Widget _footer() {
    return Container(
      ...
      child: CustomButton(label: 'global.savechange'.tr(), onPressed: () {}, fullWidth: true,),
    );
  }
