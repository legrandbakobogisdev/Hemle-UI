...
class _MethodpaymentScreenState extends State<MethodpaymentScreen> {
  List<Map<String, String>> methods = [
    {"id": "1", "name": "methodspayment.orangemoney".tr(), "img": "assets/images/47.svg"},
    {"id": "2", "name": "methodspayment.mobilemoney".tr(), "img": "assets/images/48.svg"},
              ...
              return GestureDetector(
                onTap: () {
                  showConfirmPaymentModal(
                    ...
                    amount: '10000', 
                    method: method['name']!, 
                    recipient: 'Mariif School', 
                    onConfirm: () {
                      Navigator.push(
                        context, 
                        CupertinoPageRoute(
                          builder: (context) => const CardInformationScreen(),
                        ),
                      );
                    },
                  );
