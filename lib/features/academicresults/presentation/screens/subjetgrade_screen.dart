  ...
  final List<Map<String, dynamic>> _comments = [
    {
      ...
      'userName': 'Marie L.',
      'comment':
          'Excellent school with dedicated teachers. My daughter is thriving in this program.',
      'date': '14/12/2024',
    },
    {
      'id': 2,
      'userName': 'John D.',
      'comment':
          'Great facilities and caring staff. The curriculum is well-structured.',
      'date': '10/12/2024',
    },
  ];
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(label: review['comment'] as String),
              ],
            ),
          );
        },
  ...
  Widget _buildGradesHistory() {
    return Column(
      ...
      children: [
        ...
        Column(
          children: [
            _buildHistoryRow('Maths', '18/20'),
            _buildHistoryRow('English', '20/20'),
            _buildHistoryRow('Sciences', '15/20'),
            _buildHistoryRow('Histoire', '19/20'),
          ],
        ),
      ],
    );
