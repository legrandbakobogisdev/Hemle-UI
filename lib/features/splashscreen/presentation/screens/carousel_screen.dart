    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomText(label: "onboarding.lastpagedesc".tr(), fontSize: 16, fontWeight: FontWeight.w500, textAlign: TextAlign.center,), //Choose how you’d like to continue

          const SizedBox(height: 20),

          CustomButton(
            label: 'global.createanaccount'.tr(),
            fullWidth: true,
            onPressed: () {
              Navigator.push(
                context,
          ...
          CustomButton(
            label: 'onboarding.ihaveaccountlogin'.tr(), //I have an account: Login 
            fullWidth: true,
            color: Color(0xffDEEBFF),
          ...
          CupertinoButton(
            ...
            child: CustomText(
              label: 'global.forgetmypassword'.tr(),
          ...
          CupertinoButton(
            ...
            child: Row(
              ...
              children: [
                CustomText(
                  label: 'onboarding.continueasguest'.tr(),
                  color: AppColors.primary,
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                ),
